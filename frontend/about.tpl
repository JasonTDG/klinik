...
<li><a href="{#$__C#}/about">{#$actionTitle#}</a></li>
  ...
  <div class="container">
      <div class="row">
        ...
        {#if $row.subject.pic1||$row.subject.subject1||$row.subject.text1#}
          <section class="page-content-section page-aboutus">
            <div class="container">
              <div class="row">
            ...
            {#if $row.subject.text1#}<p>{#$row.subject.text1|nl2br#}</p>{#/if#}
                ...
                {#/if#} 
                {#if $row.subject.pic2||$row.subject.subject2||$row.subject.text2#}
          <section class="page-content-section page-aboutus">
            <div class="container">
              <div class="row">
              {#if $row.subject.pic2#}<div class="col-md-7 aboutus-company-img"><img src="{#$__U#}/{#$row.subject.pic2#}" alt="company-img"></div>{#/if#} 
                ...
                {#/if#} 
              {#if $row.subject.pic3||$row.subject.subject3||$row.subject.text3#}
          <section class="page-content-section page-aboutus">
            <div class="container">
              <div class="row">
             {#if $row.subject.pic3#}<div class="col-md-7 aboutus-company-img"><img src="{#$__U#}/{#$row.subject.pic3#}" alt="company-img"></div>{#/if#}
              ...
              {#if $row.subject.text3#}<p>{#$row.subject.text3|nl2br#}</p>{#/if#}
                ...
                {#/if#} 
          {#if $row.subject.pic4||$row.subject.subject4||$row.subject.text4#}
          <section class="page-content-section page-aboutus">
            <div class="container">
              <div class="row">
             ...
             {#/if#}
         {#if $row.subject.pic5||$row.subject.subject5||$row.subject.text5#}
          <section class="page-content-section page-aboutus">
            <div class="container">
              <div class="row">
