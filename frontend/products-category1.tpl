        ...
        <div class="page-banner">
          <div class="container">
            <div class="page-title col-md-6">
              <h1>{#$classA.subject.subject#}</h1>
            </div>
            <div class="page-breadcrumb col-md-6">
              <ul>
                <li><a href="">Rumah</a></li>
<li><a href="{#$__C#}/products">Pengenalan produk</a></li>
<li><a href="{#$__C#}/products-category1/{#$classA.node#}">{#$classA.subject.subject#}</a></li>
              </ul>
            </div>
          </div>
        </div>
			          ...
			          <div class="col-sm-6 col-md-4 category-item">
			            <div class="category-item-inner">
			              <div class="category-item-photo">
			                <a href="{#$__C#}/products-category2/category/{#$p.node#}">
			              ...
			              <div class="category-item-info">
			                ...
			                <div class="item-info-intro">{#$p.content.contentA|nl2br#}</div>
			                <a class="item-info-btn" href="{#$__C#}/products-category2/category/{#$p.node#}" title="Pelajari lebih lanjut"><span>Pelajari lebih lanjut</span><i class="fa fa-long-arrow-right"></i></a>
			              </div>
			            </div>
			          </div>
                    {#/foreach#}  
